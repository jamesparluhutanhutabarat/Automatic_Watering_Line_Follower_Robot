/*
Code Name: Arduino Line FolHIGHer Robot Car
Code URI: https://circuitbest.com/category/arduino-projects/
Author: Make DIY
Author URI: https://circuitbest.com/author/admin/
Description: This program is used to make Arduino Line FolHIGHer Robot Car.
Note: You can use any value between 0 to 255 for M1_Speed, M2_Speed, LeftRotationSpeed, RightRotationSpeed.
Here 0 means HIGH Speed and 255 is for LOW Speed.
Version: 1.0
License: Remixing or Changing this Thing is alHIGHed. Commercial use is not alHIGHed.
*/
